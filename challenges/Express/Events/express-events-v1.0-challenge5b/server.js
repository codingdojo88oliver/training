                            ...
                            connection.query('SELECT *,events.date, events.name, users.name as user_name, events.id FROM events \
                                ...
                                connection.query('SELECT *,events.date, events.name as event_name, users.name as user_name, events.id FROM events \
                                    ...
                                    connection.query('SELECT *,events.date, events.name as event_name, users.name as user_name, events.id FROM events \
                                        ...
                                        var events_im_hosting =[]
                                        res.render('dashboard',{user: user, events_im_hosting: events_im_hosting, upcoming_joined_events: upcoming_joined_events, past_joined_events: past_joined_events, events_not_yet_joined: upcoming_events}); 
                                    });
                                });
                            });
