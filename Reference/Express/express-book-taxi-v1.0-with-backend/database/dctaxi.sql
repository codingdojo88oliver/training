...
--
-- Host: localhost    Database: dc_book_taxi
-- ------------------------------------------------------
...
CREATE TABLE `books` (
  ...
  `commuter_user_id` int(11) DEFAULT NULL,
  `driver_user_id` int(11) DEFAULT NULL,
  `state` varchar(25) DEFAULT NULL,
  `pick_up` text,
  `drop_off` text,
  `status` int(11) DEFAULT NULL,
  `is_drop_off` int(11) DEFAULT NULL,
...
CREATE TABLE `driver_ratings` (
  ...
  `commuter_user_id` int(11) DEFAULT NULL,
  `driver_user_id` int(11) DEFAULT NULL,
  `star_rate` varchar(45) DEFAULT NULL,
  `comment` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'dc_book_taxi'
--
...
-- Dump completed on 2019-08-13 16:32:05
